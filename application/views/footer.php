...
<!-- jQuery  -->
<script type="text/javascript" src="<?= ASSET_URL ?>js/jquery-1.11.2.min.js"></script>
...
<!-- PORTFOLIO SCRIPTS -->
<script type="text/javascript" src="<?= ASSET_URL ?>js/isotope.pkgd.min.js"></script>
...
<!-- COUNTER -->
<script type="text/javascript" src="<?= ASSET_URL ?>js/jquery.countTo.js"></script>
...
<script type="text/javascript" src="<?= ASSET_URL ?>rs-plugin/js/jquery.themepunch.tools.min.js"></script>   
<script type="text/javascript" src="<?= ASSET_URL ?>rs-plugin/js/jquery.themepunch.revolution-parallax.min.js"></script>
